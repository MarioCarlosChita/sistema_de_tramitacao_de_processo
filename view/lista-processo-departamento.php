                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Lista de Processo<span> >>> <a href="login-departamento.php">Pagina Inicial</a></span></h1>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <?php
                                                ...
                                                $index = 0;
                                                $queries = $conexao->getconexao()->prepare('select * from processo,funcionario where  processo.Idfuncionario=funcionario.ID_funcionario && funcionario.Id_departamento =:id');
