            ...
            <div class="main">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Atualizar Funcionario<span> >>> <a href="login-departamento.php">Pagina Inicial</a></span></h1>
                                </div>
                    ...
                    <section id="main-content">
                        <form  method="POST"  action="../modal/admin-setting.php?funcao=alterar-funcionario&&id=<?php echo $_GET['id']?>">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="basic-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control input-flat" value="Senha" name="senha" required="">
                                            </div>
                                            <div class="form-group">
