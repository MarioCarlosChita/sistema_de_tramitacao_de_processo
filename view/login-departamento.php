                                     ...
                                     <div class="stat-widget-one">
                                         ...
                                         <div class="stat-content dib">
                                             ...
                                             <?php
                                                   $conexao = new conexao();
                                                   $id_departamento =  $_SESSION['id'];
                                                   $queries =  $conexao->getconexao()->prepare('select * from processo,funcionario where funcionario.Id_Departamento=:id and funcionario.ID_funcionario=processo.Idfuncionario');
                                                   $queries->execute(array(
                                                        ':id'=>$id_departamento     
                                                   ));
                                                   echo $queries->rowCount();
                                                ...
                                                <?php
                                                  ...
                                                  if ($queries->rowCount() != 0):
                                                      while ($key = $queries->fetch()):
                                                        ...
                                                        echo  '<span> Funcionário </span>';
                                                        echo '<br>';
                                                        echo '<span style="font-size:23px;">'.$key['Nome'].'</span>'.'</div>';
                                                        echo  '<div class="testimonial-author-position">Sua Função: '. $key['Funcao'];
                                                        echo  '</div>';
                                                        echo  ' </div>
                                                               </div>';    
                             ...
                             <div class="col-lg-8">
                                 <div class="card" style="margin-top:14px;">
                                     <div class="card-title pr">
                                         <h4>Funcionario Cadastrado Recetemente...</h4>
                                     </div>
                                     <div class="card-body">
