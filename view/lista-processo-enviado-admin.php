                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Lista Gerais de Processo Enviados<span> >>> <a href="login-departamento.php">Pagina Inicial</a></span></h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <?php
                                               ...
                                               function departamentoorigim($id){
                                                    $conexao = new conexao();
                                                   ...
                                                   $nova_queries =  $conexao->getconexao()->prepare('select * from departamento where Id_Departamento=:id');
                                                   $nova_queries->execute(Array(
                                                        ":id"=>$id_departamento
                                                   ));

                                                   while($folha =$nova_queries->fetch()):
                                                          return $folha['Nome'];
                                                   endwhile; 
                                                ...
                                                $index = 0;
                                                $queries = $conexao->getconexao()->prepare('select * from enviados');
                                                $queries->execute();
                                                if ($queries->rowCount() != 0):
                                                    while ($key = $queries->fetch(PDO::FETCH_ASSOC)):
                                                        ...
                                                        echo "<td>".departamentoorigim($key['id_emissor'])."</td>";
                                                        echo "</tr>";
                                                    endwhile;
                                                else:
                                                    echo '<tr>';
