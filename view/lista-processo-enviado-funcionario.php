                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Lista de Processo Enviados<span> >>> <a href="funcionario-page.php">Pagina Inicial</a></span></h1>
                                </div>
                                        ...
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                              ...
                                              for(;$row =  $consulta->fetch(PDO::FETCH_ASSOC);):
                                                ...
                                                $queries = $conexao->getconexao()->prepare('select * from enviados where id_emissor=:id order by Nome ');
                                                $queries->execute(array(
                                                     ':id'=>$_SESSION['id']
                                                ));
                                                if ($queries->rowCount() != 0):
                                                    while ($key = $queries->fetch()):
                                                        ...
                                                        echo "<td>".nomeemissor($key['id_receptor'])."</td>";
                                                        echo "<td>".nomedepartamento($key['id_emissor'])."</td>";
                                                        echo "<td>".nomedepartamento($key['id_receptor'])."</td>";
                                                        echo "</tr>";
                                                    endwhile;
                                                else:
                                                    echo '<tr>';
