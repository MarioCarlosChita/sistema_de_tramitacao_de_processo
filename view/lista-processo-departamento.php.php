            ...
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        ...
                        <li>
                            <a class="sidebar-sub-toggle"><i class="ti-book"></i> Funcionario <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul> 
                               <li><a href="add-funcionario-departamento.php"> Add Funcionário</a></li>
                        ...
                        <li><a  href="logout.php?funcao=sair-departamento"><i class="ti-close"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Lista de Processo<span> >>> <a href="admin-page.php">Pagina Inicial</a></span></h1>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <?php
                                                ...
                                                $index = 0;
                                                $queries = $conexao->getconexao()->prepare('select * from processo,funcionario where funcionario.Id_departamento=:id and processo.Idfuncionario = funcionario.ID_funcionario');
                                                ...
                                                if ($queries->rowCount() != 0):
                                                    while ($key = $queries->fetch()):
                                                        ...
                                                        echo '<td><a href="../upload-files/' .$key['Ficheiro']. '">Ficheiro</a></td>';
                                                         echo "<td>" .nome_funcionario($key['Idfuncionario']). "</td>";
                                                        echo "</tr>";
                                                    endwhile;
                                                else:
                                                    echo '<tr>';
