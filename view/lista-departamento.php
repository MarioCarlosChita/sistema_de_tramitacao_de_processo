                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Lista de Departamento<span> >>> <a href="admin-page.php">Pagina Inicial</a></span></h1>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                if ($queries->rowCount() != 0):
                                                    while ($key = $queries->fetch()):
                                                        ...
                                                        echo '<td>';
                                                        echo "<a href='update-departamento.php?funcao=update&&id=${id}&&nome=${nome}' class='btn btn-success btn-rounded m-b-10 m-l-5'>Alterar</a>";
                                                        echo "<a href='../modal/admin-setting.php?funcao=deletar&&id=${id}' class='btn btn-danger btn-rounded m-b-10 m-l-5'>Deletar</a>";
