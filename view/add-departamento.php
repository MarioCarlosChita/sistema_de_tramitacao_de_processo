            ...
            <div class="main">
                <div class="container-fluid">
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>Adicionar Departamento<span> >>> <a href="admin-page.php">Pagina Inicial</a></span></h1>
                                </div>
                    ...
                    <section id="main-content">
                        <form  method="POST"  action="../modal/admin-setting.php?funcao=cadastrar">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="basic-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-flat" placeholder="Departamento"name="nome" required="">
                                            </div>
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Usuario</p>
                                                <input type="text" class="form-control input-flat" placeholder="Usuario"name="usuario" required="">
                                            </div>
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">Email</p>
                                                <input type="text" class="form-control input-flat" placeholder="example@gmail.com" name="email" required="">
                                            </div>
                                            <div class="form-group">
